...
public abstract class AZBaseAdapter<DATA extends IAZItem, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {

	protected List<DATA> mDataList;

	public AZBaseAdapter(List<DATA> dataList) {
		mDataList = dataList;
	}
